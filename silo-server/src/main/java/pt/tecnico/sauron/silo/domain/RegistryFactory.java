...
public class RegistryFactory {
    ...
    public Registry build(Camera cam, String type, String id, Date time) throws InvalidTypeException, IncorrectDataException {
        switch(type) {
            case "car":
    ...
    private Registry buildCar(Camera cam, String type, String id, Date time) throws IncorrectDataException {
        //Validate id
    ...
    private Registry buildPerson(Camera cam, String type, String id, Date time) throws IncorrectDataException {
        //Validate id
